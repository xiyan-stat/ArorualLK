...
# examples:
# ground
exp.7.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=420, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.7.10 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=430, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.7.30 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=450, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.8.30 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                           nmlat=363, nmlt=363, time_pt=510, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                           NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")


exp.9.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=540, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.9.30 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=570, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.10.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=600, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

# no ground
exp.11.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                           nmlat=363, nmlt=363, time_pt=660, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                           NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")

exp.11.30 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                           nmlat=363, nmlt=363, time_pt=690, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                           NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")
#####################
# main
exp.12.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=720, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")
#################################
exp.12.10 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                          nmlat=363, nmlt=363, time_pt=730, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                          NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")


###########
exp.15.1 <- LK.auroral.10m(data1 = data.flux.inter_n, data2 = data.flux.sate_n, data3=data.flux.emp_n, data4 = data.flux.grd_n,
                           nmlat=363, nmlt=363, time_pt=900, ratio1=1/6, ratio2=1/40, ratio3=1/2, 
                           NCs=c(5,20,25), nlevels= c(1,1,3), kn = c(60,20,10), bmethod="1")
...
animation::saveGIF(
  ...
  movie.name = "ScaleCompare_ob.gif",
  ani.width = 1044, ani.height = 400
)

result_9 <- exp.9.1$res[exp.9.1$res$source=="c.High",]

write.csv(result_9, file="Simulated Aurora at 9.csv")

result_7 <- exp.7.1$res
write.csv(result_7, file="Simulated Aurora at 7.csv")
result_10 <- exp.10.1$res
write.csv(result_10, file="Simulated Aurora at 10.csv")

result_11 <- exp.11.1$res
write.csv(result_11, file="Simulated Aurora at 11.csv")